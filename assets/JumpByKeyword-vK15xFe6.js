import{d as b,x as e,o as B,k as f,B as v,W as S,q as o,Y as y}from"./index-9zeyy3xN.js";const R=["innerHTML"],A=b({__name:"JumpByKeyword",setup(g){const i=e(""),a=e(`
1. Blob
...
`),t=e([]),s=e(null);function c(){const u=new RegExp(i.value,"gi"),l=/<span class="highlight">([^<]+)<\/span>/g;a.value=a.value.replace(l,"$1"),a.value=a.value.replace(u,n=>`<span class="highlight">${n}</span>`)}const d=e(0),r=e(0);function p(){t.value=s.value.querySelectorAll(".highlight"),d.value=t.value.length,r.value<d.value?t.value[r.value++].scrollIntoView({behavior:"smooth"}):(r.value=0,t.value[r.value].scrollIntoView({behavior:"smooth"}))}return(u,l)=>(B(),f("div",null,[v(o("input",{"onUpdate:modelValue":l[0]||(l[0]=n=>i.value=n),placeholder:"Enter search keyword",onKeydown:y(c,["enter"])},null,544),[[S,i.value]]),o("button",{onClick:c},"Search"),o("button",{onClick:p},"next"),o("div",{ref_key:"content",ref:s,style:{height:"300px","overflow-y":"scroll"},innerHTML:a.value},null,8,R)]))}});export{A as default};
